...
from heart_cleveland.data.make_dataset import (
    download_from_gdrive,
    unzip_downloaded_data,
    read_data,
    split_train_test_data,
)
from heart_cleveland.enities.train_pipeline_params import read_training_pipeline_params
...
from heart_cleveland.models.train_model import train_model
from heart_cleveland.models.predict_model import (
    predict_model,
    count_metrics,
...
def run_train_pipeline(training_pipeline_params):
    ...
    logger.info(f"path_to_model = {path_to_model}")
    logger.info(f"path_to_metrics = {training_pipeline_params.metric_path}")
